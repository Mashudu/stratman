...
<div class="p-4 p-md-5 mb-5 text-white rounded bg-dark">
  <div class="col-md-10 px-0">
    <h2 class="display-5 font-italic">Communication Plan</h2>
...
<div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
  ...
  <!-- Table End -->
<br>
<h2>Enter Communication Plan</h2>
<form>
  <div class="form-floating">
    <textarea class="ckeditor form-control" id="txtCommunication" name = "txtCommunication" style="height: 100px"></textarea>
  </div>
  <br>
