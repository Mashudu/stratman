...
<div class="p-4 p-md-5 mb-5 text-white rounded bg-dark">
  <div class="col-md-10 px-0">
    <h1 class="display-5 font-italic">Developing an Operating or Action Plan</h1>
    <p class="lead my-4">Action planning is the process that guides the day-to-day of an organization or project.  It is the process of planning what needs to be done, when it needs to be done, by whom it needs to be done, and what resources or inputs are needed to do it.</p>
...
<div class="row row-cols-1 row-cols-md-4 mb-4 text-center">
  <div class="col">
    ...
    <div class="card-header">
      <h4 class="my-0 fw-normal">OUTCOMES</h4>
    </div>
    <div class="card-body"> 
  ...
  <div class="col">
    ...
    <div class="card-header">
      <h4 class="my-0 fw-normal">KEY INDICATORS</h4>
    </div>
    <div class="card-body ">
