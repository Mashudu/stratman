...
<div class="p-4 p-md-5 mb-5 text-white rounded bg-dark">
  <div class="col-md-10 px-0">
    <h2 class="display-5 font-italic">Strategic Framework Analysis</h2>
...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addFrameworkModal">
  + Add New Issue
</button>

<!-- Modal -->
<div class="modal fade" id="addFrameworkModall" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Frameworks Add Data</h5>
      ...
      <div class="modal-body">
        <div class="mb-3">
          <select name="issueType" class="form-select" aria-label="Default select example">
            ...
            <option value="strategys">Strategies</option>
          </select>
        </div>
        <div class="mb-3">
  ...
  <!-- Table Start -->
   <!-- Modal -->
<div class="modal fade" id="editFrameworkModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Frameworks Edit Data</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
