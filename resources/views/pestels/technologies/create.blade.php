...
<div class="p-4 p-md-5 mb-5 text-white rounded bg-dark">
  <div class="col-md-10 px-0">
    <h2 class="display-5 font-italic">Enter the political issues</h2>
...
<h2>Enter Issue</h2>
  ...
  <div class="form-floating">
    <textarea class="ckeditor form-control" id="txtPolitical" name = "txt.Political" style="height: 100px"></textarea>
  </div>
  <br>

  <button type="button" class="btn btn-primary">Submit Political</button>
